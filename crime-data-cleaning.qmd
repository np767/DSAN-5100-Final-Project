...
pop_1980_1989 <- read_csv("us-pop/US-pop-1980-1989.csv")

pop_1990_1999 <- read_csv("us-pop/US-pop-1990-1999.csv")

pop_2000_2009 <- read_csv("us-pop/US-pop-2000-2009.csv")

pop_2010_2019 <- read_csv("us-pop/US-pop-2010-2019.csv")

pop_2020_2024 <- read_csv("us-pop/US-pop-2020-2024.csv")
