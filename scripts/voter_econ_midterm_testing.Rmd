---
title: "Voter Turnout X Economic Metric Hypothesis Testing - Midterm Years"
format:
  html:
...
econ_voter <- econ_voter %>% filter(election_type == "midterm")
```
...
knitr::kable(summary_results, caption = "Summary of ANOVA and Pairwise T-Tests: Economic Metrics vs Normalized VEP Turnout (Midterm Elections)")
```
